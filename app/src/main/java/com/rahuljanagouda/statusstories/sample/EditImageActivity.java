...
import com.rahuljanagouda.statusstories.sample.base.BaseActivity;
import com.rahuljanagouda.statusstories.sample.filters.FilterListener;
import com.rahuljanagouda.statusstories.sample.filters.FilterViewAdapter;
import com.rahuljanagouda.statusstories.sample.tools.EditingToolsAdapter;
import com.rahuljanagouda.statusstories.sample.tools.ToolType;
...
filePath=Uri.fromFile(new File(imagePath));
                       uploadImage();
        ...
        ref.putFile(filePath)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(EditImageActivity.this,"Uploaded",Toast.LENGTH_SHORT).show();
                                ...
                                databaseReferencePhoto2.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        if (dataSnapshot.hasChild("photo")) {
                                            ...
                                            photoList.clear();
                                            Intent intent = new Intent(EditImageActivity.this, Main2Activity.class);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(EditImageActivity.this,"Failed "+e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                })
